...
## 4.2. Get PCAs at precursor level at this point
```{r}
...
# 4. Filter based on z-score of TIC and number of precursors identified
## 4.1. TIC
```{r}
# Run filtering
data_filtered_TIC <- filter_z_score_tic(data_filtered_Q, 
                                        stats_file,
                                        label_outliers = T)
...
## 4.2. Number of identified precursors
```{r}
# Run filtering
...
# 5. Filter based on detection threshold/sample fraction
## 5.1. Perform filtering based on number of samples present per strain
```{r}
# Remove already unnecessary version of the report (2 steps ago)
