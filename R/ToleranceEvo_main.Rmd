...
## 1.5. Heatmaps
### 1.5.1. Heatmap with Z-score based on median per protein - for all samples
...
### 1.5.2. Separate heatmaps for each treatment group
...
### 1.5.3. Let me actually separate this by Strain.Type_Passage
```{r}
treatments <- unique(metadata$Treatment)[!(unique(metadata$Treatment) %in% c("QC"))]
